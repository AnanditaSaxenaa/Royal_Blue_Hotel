...
<div class="container-fluid">
    <a class="navbar-brand me-5 fw-bold fs-3 h-font" href="index.php">Royal Blue Hotel</a>
...
<div class="modal-dialog modal-lg">
    ...
    <span class="badge text-bg-light mb-3 text-wrap lh-base">
        Note: Your details must match with your ID (Aadhaar card, Driving license, Passport etc.)
